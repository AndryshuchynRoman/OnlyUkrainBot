...
class UserRegisterConversationHandler(BaseHandler):
        ...
        conversation_handler = ConversationHandler(
            ...
            states={
                ...
                STATE_PHONE_NUMBER: [
                    ...
                    MessageHandler(filters.TEXT, cls.phone_number),
                ],
                STATE_EMAIL: [MessageHandler(filters.TEXT, cls.state_email)]
            },
    ...
    async def phone_number(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(f'Киньте вашу пошту:')
